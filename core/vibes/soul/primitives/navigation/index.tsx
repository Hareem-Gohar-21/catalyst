...
export const Navigation = forwardRef(function Navigation<S extends SearchResult>(
  ...
  return (
    <NavigationMenu.Root
      className={clsx('relative mx-auto w-full max-w-screen-2xl @container bg-slate-500', className)}
      delayDuration={0}
    ...
    >
      <div
        className={clsx(
          'flex items-center justify-between gap-1 bg-slate-600 py-2 pl-3 pr-2 transition-shadow @4xl:rounded-2xl @4xl:px-2 @4xl:pl-6 @4xl:pr-2.5',
          isFloating
